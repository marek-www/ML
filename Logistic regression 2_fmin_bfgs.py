...
J = costFunctionReg(initial_theta, X, y, lamb)
grad = gradient1(initial_theta, X, y, lamb)
J = costFunctionReg(test_theta, X, y, 10)
grad = gradient1(test_theta, X, y, 10)

theta = sc.fmin_bfgs(costFunctionReg, initial_theta, fprime=gradient1, args=(X, y, lamb))
